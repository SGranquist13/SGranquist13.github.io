// Dithered shader background based on reactbits.dev Dither effect.
function initDitherBackground() {
    ...
    const config = {
        ...
        waveFrequency: 3.0,
        waveAmplitude: 0.3,
        waveColor: new THREE.Color(0.45, 0.45, 0.45),
        colorNum: 4.0,
        pixelSize: 2.0,
        mouseRadius: 1.0
    };
    ...
    const uniforms = {
        ...
        waveColor: new THREE.Uniform(config.waveColor),
    ...
    // Mouse interaction disabled by request.
